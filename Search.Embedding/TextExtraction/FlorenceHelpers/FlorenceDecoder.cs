    ...
    CancellationToken ct)
        {
            ...
            for (int step = 0; step < MaxNewTokens; step++)
            {
                ...
                // embed FULL sequence, not just last token, this is main issue!!!!!
                var inputEmbeds = _embedding.EmbedPromptFromIds(tokens.ToArray());
                ...
                var inputs = new List<NamedOnnxValue>
        {
            ...
            NamedOnnxValue.CreateFromTensor("inputs_embeds", inputEmbeds),
            ...
            NamedOnnxValue.CreateFromTensor("use_cache_branch",
                ...
                if (nextToken == EosTokenId && step > 0)
                    break;
